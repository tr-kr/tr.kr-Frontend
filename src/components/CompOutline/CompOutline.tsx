...
const CompOutline = () => {
  ...
  const [selectedPeriod, setSelectedPeriod] = useState('모집기간');
  ...
  return (
    <div className="flex justify-center mt-[50px] h-[800px]">
      <div className="mt-[5%]">
        <div className="flex">
      ...
      <div className="flex flex-col justify-between items-center h-[500px] mt-[3%]">
        <div
          className={`grid grid-cols-1 pt-5 text-center text-[#3F4FE1] w-[342px] h-[391px] mb-[30px] rounded-[7px] border-[#3F4FE1] border-[3px] p-2 text-[24px]`}
        >
          <div>
            일정
            <Calendar
              ...
              tileClassName={({ date, view }) => {
                const targetMarks =
                  selectedPeriod === '모집기간' ? crueMarks : compMarks;
                if (
                  targetMarks.find(
