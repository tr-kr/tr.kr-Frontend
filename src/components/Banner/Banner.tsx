...
const Banner = () => {
  ...
  useEffect(() => {
    switch (active) {
      case '대회 개요':
        navigate('comp-outline');
        break;
      case '경기 규정':
        navigate('rule-book');
        break;
      case '참가팀':
        navigate('participating-team');
        break;
      case '대진표':
        navigate('bracket');
        break;
    ...
    <div>
      ...
      <div className="relative">
        ...
        <div className="absolute top-[17px] right-[52px] w-[278px] h-auto rounded-[7px] bg-[#2C2C2C] border-[#C27935] border-[3px] text-center">
          <div className="text-[24px] text-[#C27935] mt-[20px]">
            접수마감까지
          </div>
        ...
        <div className="absolute top-[365px] right-[52px] w-[278px] h-[58px] rounded-[7px] bg-[#C27935] border-[#2C2C2C] border-[3px] text-center text-white text-[24px] p-2">
          준비중
        </div>
        {/* {접수마감 박스} */}
      </div>
        ...
        {navItems.map((item) => (
          <li
            className={`
                            ${
                              item === active &&
                              'border-b-[1px] text-[#3F4FE1] border-primary'
                            }
                            py-4 ml-[5%]`}
